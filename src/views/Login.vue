		...
		<div class="login-container">
			...
			<div class="login-right">
				<el-form :model="loginForm" :rules="loginRules" ref="loginForm" class="login-form"
					...
					<p style="margin-left: 4px; text-align: left;font-size: 28px;margin-bottom: 30px">鱼眼电影后台管理系统</p>

					<el-form-item prop="username">
						<el-input name="username" class="login-input" prefix-icon="el-icon-user" placeholder="用户名/工号"
							clearable auto-complete="off" v-model="loginForm.username" />
					</el-form-item>

					<el-form-item prop="password">
						<el-input name="password" class="login-input" show-password prefix-icon="el-icon-lock"
							placeholder="请输入密码" v-model="loginForm.password" />
					</el-form-item>

					<el-form-item class="form-captcha" prop="code">
						<el-input placeholder="验证码" name="code" prefix-icon="el-icon-c-scale-to-original"
							class="login-input" style="width: 52%;float: left" type="text" v-model="loginForm.code" />
						<img style="width: 162px; height: 42px;float: left;margin-left: 22px" :src="captchaImg"
							@click="getCaptchaImg" />
					</el-form-item>
